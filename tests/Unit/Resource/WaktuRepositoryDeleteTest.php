...
class WaktuRepositoryDeleteTest extends TestCase
{
    public function test_delete_removes_slot_and_jadwal_dependencies_before_deleting_waktu(): void
    {
        $this->seedScheduledWaktu();

        $repository = new EloquentWaktuRepository(new WaktuModel());

        $repository->delete(1);

        $this->assertDatabaseMissing('waktu', ['id' => 1]);
    ...
    private function seedScheduledWaktu(): void
    {
